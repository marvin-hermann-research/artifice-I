...
const gpio_num_t ServoDriver::SERVO_PINS[] = {GPIO_NUM_17, GPIO_NUM_18, GPIO_NUM_16, GPIO_NUM_19};
const ledc_channel_t ServoDriver::LEDC_CHANNELS[] = {LEDC_CHANNEL_0, LEDC_CHANNEL_1, LEDC_CHANNEL_2, LEDC_CHANNEL_3};
const ledc_timer_t ServoDriver::LEDC_TIMERS[] = {LEDC_TIMER_0, LEDC_TIMER_1, LEDC_TIMER_2, LEDC_TIMER_3};
